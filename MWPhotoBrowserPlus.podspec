Pod::Spec.new do |s|
  ...
  s.name = 'MWPhotoBrowserPlus'
  s.version = '2.1.3'
  s.license = 'MIT'
  s.summary = 'A SLIGHTLY MODIFIED simple iOS photo and video browser with optional grid view, captions and selections.'
  s.description = <<-DESCRIPTION
                  MWPhotoBrowserPlus can display one or more images or videos by providing either UIImage
                  objects, PHAsset objects, or URLs to library assets, web images/videos or local files.
                  The photo browser handles the downloading and caching of photos from the web seamlessly.
                  Photos can be zoomed and panned, and optional (customisable) captions can be displayed.
                  NOTE: This has a few targeted fixes needed by some dude on the internet, so you should
                        probably NOT USE this - stick to https://github.com/mwaterfall/MWPhotoBrowser instead.
                  DESCRIPTION
  s.screenshots = [
  ...
  s.source = {
    :git => 'https://github.com/scottcc/MWPhotoBrowserPlus.git',
    :tag => '2.1.3'
  }
  s.platform = :ios, '7.0'
  s.source_files = 'Pod/Classes/**/*'
  s.resource_bundles = {
    'MWPhotoBrowserPlus' => ['Pod/Assets/*.png']
  }
  s.requires_arc = true
